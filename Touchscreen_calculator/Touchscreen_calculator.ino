...
TftSpfd5408 tft(LCD_CS, LCD_CD, LCD_WR, LCD_RD, LCD_RESET); //Start communication with LCD
...
TSPoint waitTouch() {
  ...
  q.x = 320-map(p.y, TS_MINX, TS_MAXX, 0, 320);
  q.y = map(p.x, TS_MINY, TS_MAXY, 0, 240);;
  return q;
}
